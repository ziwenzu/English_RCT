...
\date{ \monthyear\today \\ \vspace{0.2cm} Pre-Analysis Plan}
...
\begin{abstract}  
\noindent  
Authoritarian governments devote significant resources to controlling information, yet the extent to which foreign media can penetrate censorship and shift political attitudes remains unclear. This pre-registered field experiment tests the effects of Western media exposure among Chinese university-age adults preparing to study abroad. Over twelve weeks, participants are randomly assigned to receive articles and videos from major western outlets (New York Times, Wall Street Journal, The Economist, Washington Post) and English-language Chinese state media (China Daily). Treatments vary by ideological positions—pro-China, anti-China, apolitical, or unrelated control—and by intensity of exposure. Weekly quizzes and engagement logs track compliance and demand, while baseline and endline surveys measure changes in regime support, censorship attitudes, nationalism, and media trust. The factorial design identifies whether negative frames undermine regime legitimacy, positive frames bolster it, or mixed and apolitical content shift attitudes indirectly. By combining attitudinal and behavioral measures, the study advances theories of authoritarian information control, persuasion, and selective exposure. Findings will show whether censorship stability depends on fully blocking foreign narratives, or whether even sustained exposure leaves regime support largely intact, offering new insight into authoritarian resilience and global information flows.
\end{abstract}



 \textbf{Keywords}: Authoritarianism; Censorship; Political attitudes; China;  Persuasion
