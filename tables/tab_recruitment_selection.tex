...
\footnotesize
\item Entries compare baseline respondents who entered the randomized study sample (`recruited = 1`) with baseline respondents who did not. Differences are estimated from bivariate OLS regressions with HC2 standard errors. Recruitment was partially based on baseline quality checks and study-abroad interest, so this table is informative about sample selection and external validity rather than experimental balance.
\end{tablenotes}
\end{threeparttable}
\end{table}
