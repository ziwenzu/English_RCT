...
\begin{abstract}
\noindent How does exposure to foreign media influence public opinion under authoritarian censorship? I address this question with a 12-week field experiment embedded in a major Chinese English test-preparation platform. The study generated 59,901 recruitment clicks, 22,317 survey starts, 12,215 participants completing the prescreen and baseline survey, and 6,365 randomized participants. The intervention follows a six-arm structure: four political treatment cells from a Pro-China/Anti-China by High/Low dose design, plus an apolitical-China arm and a non-China control arm. Weekly app logs, an endline survey (\(N=5{,}215\)), and a follow-up survey (\(N=2{,}115\)) make it possible to distinguish persuasion from selective exposure, backlash, and disengagement. I argue that foreign information in authoritarian settings does not produce a single average effect. Instead, its consequences depend on message valence, exposure dose, prior nationalism, and the perceived credibility of foreign sources.
\end{abstract}
...
The article pool draws primarily from \emph{The New York Times}, \emph{The Economist}, \emph{The Washington Post}, and \emph{The Wall Street Journal}. The pro-China pool emphasizes favorable coverage of China's governance, development, and technological performance. The anti-China pool emphasizes critical coverage of governance, political performance, debt, regulation, and international reputation. The apolitical-China pool focuses on culture, lifestyle, science, and society. The non-China control pool uses neutral non-China content matched on length and reading difficulty.

To reduce unnecessary political sensitivity, the content excludes highly taboo subjects such as Tiananmen, Xinjiang, religion, ethnic conflict, and direct personal criticism of top leaders. The focus is on policy performance, international evaluation, and soft power rather than on core political red lines. Each article was trimmed to approximately 800 words and paired with a professionally recorded close-reading video explaining vocabulary, grammar, and translation issues. Presentation was standardized across arms so that differences in response reflect message content rather than differences in pedagogical support.
